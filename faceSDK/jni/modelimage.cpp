...
//__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_00");
    if(imgdata.channels() == 3){
    //if (1){
//__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_00_00_0");
        this->imgPyrGray.resize(4);
////__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_00_00_1");
        for (int i=0; i<=3; i++)
            cv::cvtColor(imgPyramid[i], imgPyrGray[i], CV_BGR2GRAY);
////__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_00_00_2");
    }
    else {
////__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_00_01_0");
        this->imgPyrGray.resize(4);
////__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_00_01_1");
        //3 times may occur bugs
        for (int i=0; i<=3; i++){
            imgPyrGray[i] = imgPyramid[i]; //kokokokokokokokokok
        }
    }
////__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_01");
...
////__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_02");
    this->imgLoaded = true;
////__android_log_write(ANDROID_LOG_DEBUG,"Tag","fitB2_03");
    return imgLoaded;
}
